...
class Torneo(Base):
    ...
    fecha_inicio: Mapped[str] = mapped_column(DateTime(timezone=True), nullable=True)
    fecha_fin: Mapped[str] = mapped_column(DateTime(timezone=True), nullable=True)
...
class Categoria(Base):
    ...
    # criterio_emparejamiento: reactivar cuando migración 013 esté aplicada en prod
